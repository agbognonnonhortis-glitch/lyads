...
export function renderDashboard(html: string, data: OnboardingData) {
  ...
  for (const frame of doc.querySelectorAll("[data-source-width]")) {
    ...
    if (alerts) {
      ...
      toolbar.innerHTML =
        '<div class="dashboard-filters"><div class="dashboard-account-control"><span>Comptes publicitaires</span><select data-dashboard-accounts aria-label="Comptes publicitaires" multiple hidden></select><details class="dashboard-account-picker"><summary><span class="dashboard-filter-value" data-account-picker-label>Choisir un compte publicitaire</span></summary><div class="dashboard-account-menu"><div data-account-picker-options></div><button type="button" data-dashboard-action="add-account">+ Ajouter un nouveau compte publicitaire</button></div></details></div><div class="dashboard-scope-control"><span>Campagne</span><details class="dashboard-account-picker dashboard-scope-picker" data-scope-picker="campaign"><summary data-scope-label="campaign" aria-label="Campagne"><span class="dashboard-filter-value">Toutes les campagnes</span></summary><div class="dashboard-account-menu"><input type="search" data-scope-search="campaign" aria-label="Rechercher une campagne" placeholder="Rechercher une campagne"><div data-scope-options="campaign" role="group" aria-label="Campagne"></div></div></details></div><div class="dashboard-scope-control"><span>Ensemble de publicités</span><details class="dashboard-account-picker dashboard-scope-picker" data-scope-picker="adset"><summary data-scope-label="adset" aria-label="Ensemble de publicités"><span class="dashboard-filter-value">Tous les ensembles</span></summary><div class="dashboard-account-menu"><input type="search" data-scope-search="adset" aria-label="Rechercher un ensemble" placeholder="Rechercher un ensemble"><div data-scope-options="adset" role="group" aria-label="Ensemble de publicités"></div></div></details></div></div><p class="dashboard-note" data-dashboard-status role="status"></p><p class="dashboard-note" data-alert-status role="status"></p><button type="button" data-dashboard-action="alert-settings">Régler les seuils d’alerte</button>';
